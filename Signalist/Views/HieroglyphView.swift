...
// MARK: - Hieroglyph View

/// Vista principal del conversor de Jeroglíficos.
struct HieroglyphView: View {

    // MARK: - Properties

    @ObservedObject var viewModel: HieroglyphViewModel
    ...
    /// Encabezado principal del conversor de Jeroglíficos.
    private var header: some View {
        VStack(spacing: 6) {
            ...
            Text("Cifra texto con símbolos jeroglíficos egipcios")
                .font(.subheadline)
    ...
    private var modePicker: some View {
        Picker("Modo", selection: $viewModel.mode.animation(.snappy)) {
            ForEach(HieroglyphConversionMode.allCases) { option in
    ...
    /// Tarjeta donde el usuario escribe el texto o los jeroglíficos.
    private var inputCard: some View {
        VStack(alignment: .leading, spacing: 10) {

            Label(
                viewModel.mode == .textToHieroglyph ?
                "Texto de entrada" :
                "Jeroglíficos de entrada",
    ...
    private var outputCard: some View {
        ...
        // NOTE:
        // Se usa una fuente más grande (.title2) para que los glifos
        // jeroglíficos, que suelen ser más pequeños y detallados que
        // caracteres latinos comunes, se lean con claridad.
    }
