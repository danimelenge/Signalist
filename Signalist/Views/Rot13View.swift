...
/// Vista principal del conversor ROT13.
struct Rot13View: View {

    // MARK: - Properties

    @ObservedObject var viewModel: Rot13ViewModel
    ...
    /// Encabezado principal del conversor ROT13.
    private var header: some View {
        VStack(spacing: 6) {
            ...
            Text("Cifra texto con un desplazamiento fijo de 13")
                .font(.subheadline)
    ...
    private var modePicker: some View {
        Picker("Modo", selection: $viewModel.mode.animation(.snappy)) {
            ForEach(Rot13ConversionMode.allCases) { option in
    ...
    /// Tarjeta donde el usuario escribe el texto o el ROT13.
    private var inputCard: some View {
        VStack(alignment: .leading, spacing: 10) {

            Label(
                viewModel.mode == .textToRot13 ?
                "Texto de entrada" :
                "ROT13 de entrada",
