...
/// Vista principal del conversor de banderas de Semáforo naval.
struct SemaphoreView: View {

    // MARK: - Properties

    @ObservedObject var viewModel: SemaphoreViewModel
    ...
    /// Encabezado principal del conversor Semáforo.
    private var header: some View {
        VStack(spacing: 6) {
            ...
            Text("Convierte texto a banderas de semáforo naval")
                .font(.subheadline)
    ...
    private var modePicker: some View {
        Picker("Modo", selection: $viewModel.mode.animation(.snappy)) {
            ForEach(SemaphoreConversionMode.allCases) { option in
    ...
    /// Tarjeta donde el usuario escribe el texto o el semáforo.
    private var inputCard: some View {
        VStack(alignment: .leading, spacing: 10) {

            Label(
                viewModel.mode == .textToSemaphore ?
                "Texto de entrada" :
                "Semáforo de entrada",
    ...
    private var outputCard: some View {
        ...
        // NOTE:
        // Se usa una fuente más grande (.title3) que en las demás
        // pestañas para que las flechas de dirección sean más legibles,
        // ya que son el elemento visual principal del resultado.
    }
