...
/// Vista principal del conversor ROT47.
struct Rot47View: View {

    // MARK: - Properties

    @ObservedObject var viewModel: Rot47ViewModel
    ...
    /// Encabezado principal del conversor ROT47.
    private var header: some View {
        VStack(spacing: 6) {
            ...
            Text("Cifra letras, números y símbolos con un giro de 47")
                .font(.subheadline)
    ...
    private var modePicker: some View {
        Picker("Modo", selection: $viewModel.mode.animation(.snappy)) {
            ForEach(Rot47ConversionMode.allCases) { option in
    ...
    /// Tarjeta donde el usuario escribe el texto o el ROT47.
    private var inputCard: some View {
        VStack(alignment: .leading, spacing: 10) {

            Label(
                viewModel.mode == .textToRot47 ?
                "Texto de entrada" :
                "ROT47 de entrada",
